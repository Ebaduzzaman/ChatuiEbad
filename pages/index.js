    ...
    <>
      ...
      <div className={styles.topnav}>
        <div className={styles.navlogo}>
          <a href="/">EBAD Chat UI</a>
        </div>
        <div className={styles.navlinks}>
          <a href="https://platform.openai.com/docs/models/gpt-4" target="_blank"></a>
          <a href="https://replit.com/@zahid/GPT-4-UI" target="_blank"></a>
        </div>
      </div>
      <main className={styles.main}>
        ...
        <div className={styles.center}>
          ...
          <div className={styles.footer}>
            <p>Powered by <a href="https://openai.com/" target="_blank">OpenAI</a>. Built on <a href="#" target="_blank">EBAD</a>.</p>
          </div>
        </div>
      </main>
    </>
